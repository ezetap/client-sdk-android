...
public class EzeAPIConstants {
	...
	// Wallet Object key names
	public static final String KEY_WALLET_PROVIDER = "walletProvider";
	public static final String KEY_WALLET_CUSTOMER_ID = "walletCustomerAuthId";
	...
	/**
	 * Variable used when user has captured the signature & invoke ATTACH
	 * SIGNATURE API.
	 */
	...
	/**
	 * Variable used when error occurred in processing image in ATTACH SIGNATURE
	 * API.
	 */
	...
	public enum EzetapErrors {
		ERROR_INSTALL_FAILED("EZECLI_323018",
				"Failed to install the service app, Please try again later."), ERROR_MANIFEST_ACTIVITY(
				"EZECLI_323019",
				"Looks like you have not defined EzeAPIActivity in your Manifest file."), ERROR_INIT_REQUIRED(
				"EZECLI_323020", "Device not initialized, call INITIALIZE API."), ERROR_API_CHEQUE(
				"EZECLI_323021",
				"Cheque payment API is not supported in this version of SDK."), ERROR_API_SENDRECEIPT(
				"EZECLI_323022",
				"Send Receipt is not supported in this version of SDK."), ERROR_MISSING_MANDATORYPARAMS(
				"EZECLI_323023", "Mandatory parameters are missing."), ERROR_DEFAULT_INIT(
				"EZECLI_323024", "Error occured during Initialize device."), ERROR_DEFAULT_SENDRECEIPT(
				"EZECLI_323025", "Error occurred during SEND RECEIPT."), ERROR_DEFAULT_TAKEPAYMENT(
				"EZECLI_323026", "Error occurred during TAKE PAYMENT."), ERROR_DEFAULT_TRANSHISTORY(
				"EZECLI_323027", "Error occurred in TRANSACTION HISTORY."), ERROR_DEFAULT_TRANSACTIONDETAIL(
				"EZECLI_323028", "Error occurred in TRANACTION DETAIL."), ERROR_DEFAULT_ATTACHSIGNATURE(
				"EZECLI_323029", "Error occurred in ATTACH SIGNATURE."), ERROR_DEFAULT_VOIDTRANSACTION(
				"EZECLI_323030", "Error occurred in VOID TRANSACTION."), ERROR_DEFAULT_LOGOUT(
				"EZECLI_323031", "Error occurred in LOGOUT."), ERROR_API_GETTRANSACTIONDETAIL(
				"EZECLI_323032",
				"GetTransactionDetail API is not supported in this version of SDK."), ERROR_DEFAULT_GETTRANSACTIONDETAIL(
				"EZECLI_323033", "Error occurred in GET TRANSACTIONDETAIL."), ERROR_API_WALLETPAYMENT(
				"EZECLI_323034",
				"Wallet payment is not supported in this version of SDK."), ERROR_DEFAULT_WALLETPAYMENT(
				"EZECLI_323035", "Error occurred in WALLET PAYMENT API."), ERROR_CONNECTION_FAILED(
				"EZECLI_323036",
